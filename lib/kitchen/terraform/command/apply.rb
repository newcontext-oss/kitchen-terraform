...
module Kitchen
  module Terraform
    module Command
      # Apply is the class of objects which represent the <tt>terraform apply</tt> command.
      class Apply
        class << self
          # Initializes an instance by running `terraform apply`.
          #
          ...
          def call(options)
            new(options).tap do |apply|
              ...
              yield apply: apply if block_given?
            end
                ...
                command: ::Kitchen::Terraform::CommandFlag::LockTimeout.new(
                  command: ::Kitchen::Terraform::CommandFlag::Lock.new(
                    command: ::Kitchen::Terraform::CommandFlag::Color.new(
                      command: "terraform apply -auto-approve -input=false -refresh=true",
