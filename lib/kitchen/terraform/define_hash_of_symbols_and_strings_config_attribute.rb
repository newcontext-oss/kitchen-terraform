...
# Defines a hash of symbols and strings configuration attribute for a plugin class.
#
# @see http://dry-rb.org/gems/dry-validation/ DRY Validation
module ::Kitchen::Terraform::DefineHashOfSymbolsAndStringsConfigAttribute
            ...
            def self.messages
              super
                .merge(
                  en: {
                    errors: {
                      keys_are_symbols?: "keys must be symbols",
