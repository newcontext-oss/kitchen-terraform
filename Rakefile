...
def download_hashicorp_release(destination:, product:, sha256_sum:, version:)
  uri = ::URI::HTTPS.build host: "releases.hashicorp.com",
                           path: ::File.join("/", product, version, "#{product}_#{version}_linux_amd64.zip")
...
file "tmp/terraform.zip", [:terraform_version, :terraform_sha256_sum] => ["tmp"] do |current_task, arguments|
  ...
  download_hashicorp_release destination: current_task.name, product: "terraform",
                             sha256_sum: arguments.terraform_sha256_sum, version: arguments.terraform_version
end

directory "bin"

file "bin/terraform", [:terraform_version, :terraform_sha256_sum] => ["tmp/terraform.zip", "bin"] do |current_task|
...
file "tmp/terraform-provider-docker.zip", [:version, :sha256_sum] => ["tmp"] do |current_task, arguments|
  download_hashicorp_release destination: current_task.name, product: "terraform-provider-docker",
                             sha256_sum: arguments.sha256_sum, version: arguments.version
end

file "tmp/terraform-provider-local.zip", [:version, :sha256_sum] => ["tmp"] do |current_task, arguments|
  download_hashicorp_release destination: current_task.name, product: "terraform-provider-local",
                             sha256_sum: arguments.sha256_sum, version: arguments.version
end
...
namespace :tests do
  ...
  namespace :integration do
    ...
    task :basic, [:terraform_version, :terraform_sha256_sum] => ["bin/terraform"] do |current_task|
    ...
    task :no_outputs_defined, [:terraform_version, :terraform_sha256_sum] => ["bin/terraform"] do |current_task|
    ...
    task :rake_tasks, [:terraform_version, :terraform_sha256_sum] => ["bin/terraform"] do |current_task|
    ...
    file "integration/Shell Words/Plugin Directory/terraform-provider-docker",
         [:version, :sha256_sum] => ["tmp/terraform-provider-docker.zip", "integration/Shell Words/Plugin Directory"] do |current_task|
    ...
    file "integration/Shell Words/Plugin Directory/terraform-provider-local",
         [:version, :sha256_sum] => ["tmp/terraform-provider-local.zip", "integration/Shell Words/Plugin Directory"] do |current_task|
      prerequisites = current_task.prerequisites
  ...
  task :integration,
       [:terraform_version, :terraform_sha256_sum] => ["tests:integration:basic", "tests:integration:no_outputs_defined", "tests:integration:shell_words"]
end
