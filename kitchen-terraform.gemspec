...
::Gem::Specification.new do |specification|
  ...
  specification.add_development_dependency "bundler", "~> 1.16.6"
  ...
  specification.add_development_dependency "hakiri", "~> 0.7.2"
  ...
  specification.add_development_dependency "rake", "~> 12.3"
  specification.add_development_dependency "rspec", "~> 3.4"
  specification.add_development_dependency "rubyzip", "~> 1.2"
  ...
  specification.add_runtime_dependency "inspec", "~> 2.2", "!= 2.2.101", "!=2.2.102", "!= 2.2.112", "!= 2.3.4",
                                       "!= 2.3.5"
