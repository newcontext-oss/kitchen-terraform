...
This directory contains a more complex example Terraform project that
...
The [Test Kitchen configuration](.kitchen.yml) includes all of the
plugins provided by kitchen-terraform.
