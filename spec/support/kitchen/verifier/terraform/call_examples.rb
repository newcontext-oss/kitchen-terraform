...
::RSpec.shared_examples "::Kitchen::Verifier::Terraform::Call" do
  include_context "::Kitchen::Verifier::Terraform::ConfigureInspecRunnerAttributes.call" do
    let :client do
      described_instance.silent_client
    end
  end

  let :group do
    {attributes: {}, controls: ["control"], name: "name", port: 1234, username: "username"}
  end
  ...
  subject do
    lambda do
      described_method.call ::Hash.new
    end
  end
