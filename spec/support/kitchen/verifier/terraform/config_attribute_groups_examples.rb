...
::RSpec.shared_examples "config attribute :groups" do
  include_context "Kitchen::Terraform::DefineConfigAttribute", attribute: :groups do
    ...
    context "when the config associates :groups with an array which includes a hash which associates :name with an " \
              "empty string" do
      it_behaves_like "the value is invalid",
    ...
    context "when the config associates :groups with an array which includes a hash which associates :name with a " \
              "nonempty string and associates :attributes with a nonhash" do
      it_behaves_like "the value is invalid",
    ...
    context "when the config associates :groups with an array which includes a hash which associates :name with a " \
              "nonempty string and associates :attributes with an empty hash" do
      it_behaves_like "the value is valid",
                      value: [
                        {
                          name: "abc",
    ...
    context "when the config associates :groups with an array which includes a hash which associates :name with a " \
              "nonempty string and associates :controls with a nonarray" do
      it_behaves_like "the value is invalid",
    ...
    context "when the config associates :groups with an array which includes a hash which associates :name with a " \
              "nonempty string and associates :controls with an empty array" do
      it_behaves_like "the value is valid",
                      value: [
                        {
                          name: "abc",
    ...
    context "when the config associates :groups with an array which includes a hash which associates :name with a " \
              "nonempty string and associates :controls with an array which includes a nonstring" do
      it_behaves_like "the value is invalid",
    ...
    context "when the config associates :groups with an array which includes a hash which associates :name with a " \
              "nonempty string and associates :controls with an array which includes a nonempty string" do
      it_behaves_like "the value is valid",
                      value: [
                        {
                          name: "abc",
    ...
    context "when the config associates :groups with an array which includes a hash which associates :name with a " \
              "nonempty string and :hostnames with a nonstring" do
      it_behaves_like "the value is invalid",
    ...
    context "when the config associates :groups with an array which includes a hash which associates :name with a " \
              "nonempty string and associates :hostnames with an empty string" do
      it_behaves_like "the value is valid",
                      value: [
                        {
                          name: "abc",
    ...
    context "when the config associates :groups with an array which includes a hash which associates :name with a " \
              "nonempty string and associates :hostnames with a nonempty string" do
      it_behaves_like "the value is valid",
                      value: [
                        {
                          name: "abc",
    ...
    context "when the config associates :groups with an array which includes a hash which associates :name with a " \
              "nonempty string and :port with a noninteger" do
      it_behaves_like "the value is invalid",
    ...
    context "when the config associates :groups with an array which includes a hash which associates :name with a " \
              "nonempty string and associates :port with an integer" do
      it_behaves_like "the value is valid",
                      value: [
                        {
                          name: "abc",
    ...
    context "when the config associates :groups with an array which includes a hash which associates :name with a " \
              "nonempty string and :username with a nonstring" do
      it_behaves_like "the value is invalid",
    ...
    context "when the config associates :groups with an array which includes a hash which associates :name with a " \
              "nonempty string and associates :username with an empty string" do
      it_behaves_like "the value is valid",
                      value: [
                        {
                          name: "abc",
    ...
    context "when the config associates :groups with an array which includes a hash which associates :name with a " \
              "nonempty string and associates :username with a nonempty string" do
      it_behaves_like "the value is valid",
                      value: [
                        {
                          name: "abc",
