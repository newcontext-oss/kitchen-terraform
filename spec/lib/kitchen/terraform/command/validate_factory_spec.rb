...
::RSpec.describe ::Kitchen::Terraform::Command::ValidateFactory do
  subject do
  ...
  describe "#build" do
    context "when the version is less than 0.15.0" do
      ...
      specify "should return a pre 0.15.0 validate command" do
    ...
    context "when the version is greater than or equal to 0.15.0" do
      ...
      specify "should return a post 0.15.0 validate command" do
        expect(subject.build(config: config)).to be_kind_of(
