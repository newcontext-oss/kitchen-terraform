...
require "kitchen/terraform/client/init"
require "support/dry/monads/either_matchers"
require "support/kitchen/terraform/client/execute_command_context"

::RSpec.describe ::Kitchen::Terraform::Client::Init do
  describe ".call" do
    subject do
    ...
    context "when the command execution results in failure" do
      include_context "Kitchen::Terraform::Client::ExecuteCommand", command: "init"

      it do
        is_expected.to result_in_failure.with_the_value /cli init.*/
      end
    end
